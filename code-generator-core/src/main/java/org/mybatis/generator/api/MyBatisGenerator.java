...
public class MyBatisGenerator {
    ...
    public void generate(ProgressCallback callback, Set<String> contextIds,
        ...
        JavaServiceGenerator javaServiceGenerator = new JavaServiceGenerator(configuration);
        for (Context ctx : configuration.getContexts()) {
            if (ctx.getJavaServiceGeneratorConfiguration() != null) {
                javaServiceGenerator.generate();
            }
        }
        // now save the files
        if (writeFiles) {
